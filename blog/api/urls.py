from .views import api_create_view, api_delete_view, api_detail_view, api_list_view, api_update_view, api_register_view, PostListView, get_user_properties
...
urlpatterns = [
    ...
    path("user", get_user_properties, name="users"),
