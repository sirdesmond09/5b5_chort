...
class PostListCreateView(ListCreateAPIView):
    ...
    """use this view to create a new post or view post lists
    """
...
class PostListUpdateDeleteView(RetrieveUpdateDestroyAPIView):
    """Use this view to retrieve one, edit or delete a post
    """
    queryset = Post.objects.all()
    lookup_field = "slug"
    serializer_class = PostSerializer
